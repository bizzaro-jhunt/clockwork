...
#define OP_LOGLEVEL        0x74  /* Set the current syslog level */
...
#define T_OP_LOGLEVEL        0xb5  /* Set the current syslog level */
...
static const char * ASM[] = {
	...
	"loglevel",          /* T_OP_LOGLEVEL        117  0x75 */
	NULL,
};
