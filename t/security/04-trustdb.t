...
my ($stdout, $stderr);
run_ok "./cw-trust --database $TMPDB --trust $CERTS/test1.pub", 0, \$stdout, \$stderr,
...
run_ok "./cw-trust -d $TMPDB -t $CERTS/test2.pub $CERTS/test3", 0, \$stdout, \$stderr,
...
run_ok "./cw-trust -d $TMPDB -r $CERTS/test2", 0, \$stdout, \$stderr,
