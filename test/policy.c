...
void test_policy_user_addition()
{
	...
	policy_init(&pol, "user policy", 1234);
...
void test_policy_group_addition()
{
	...
	policy_init(&pol, "group policy", 1234);
...
void test_policy_file_addition()
{
	...
	policy_init(&pol, "file policy", 1234);
...
void test_policy_serialization()
{
	...
	policy_init(&pol, "serialized policy", 12346);
...
void test_policy_unserialization()
{
	...
	policy_init(&pol, "empty policy", 12346);
	...
	/* The George Thoroughgood test */
	policy_init(&pol, "george thoroughgood policy", 12346);
